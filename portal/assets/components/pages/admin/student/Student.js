                        ...
                        <div class="col-lg-6 col-7">
                            ...
                            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Öğrenci Önizleme</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-scrollable">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <Code></Code>
                                <form id="form-student-assign-result">
...
const AdminStudent = {
    ...
    mounted(){
        ...
        var data = {
            assignments_by_student_uuid: this.$route.params.student
        };     
...
Vue.component('AdminStudent', AdminStudent)
